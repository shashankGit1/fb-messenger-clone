...
function App() {
  ...
  const [messages, setMessages] = useState([
    { username: "ashu", text: "hey guys" },
  ]); /*, {username:'Aashu', text:'hey there'}]); //to keep track of all the messages*/
  ...
  const sendMessage = (event) => {
    ...
    setMessages([...messages, { username: username, text: input }]); // ... to append to the end of the list of messages and store it in input
    setInput("");
  };
